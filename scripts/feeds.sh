...
sed -i '1i src-git passwall_packages https://github.com/Openwrt-Passwall/openwrt-passwall.git;'"$PASSWALL_PACKAGES_FEEDS_COMMITS"'\nsrc-git passwall_luci https://github.com/Openwrt-Passwall/openwrt-passwall-packages.git;'"$PASSWALL_LUCI_FEEDS_COMMITS"'' feeds.conf.default
